...
<div class="card" style="width: 70rem;">
  <img src="https://upload.wikimedia.org/wikipedia/commons/3/33/Republik_Indonesia.jpg" class="card-img-top" alt="gambar proklamasi">
  <div class="card-body">
  <h5 class="card-title">GEOGRAFIS INDONESIA</h5>
    <p class="card-text">Dari Sabang di ujung Aceh sampai Merauke di tanah Papua, Indonesia terdiri dari berbagai suku bangsa, bahasa, dan agama. Berdasarkan rumpun bangsa (ras), Indonesia terdiri atas bangsa asli pribumi yakni Mongoloid Selatan/Austronesia dan Melanesia di mana bangsa Austronesia yang terbesar jumlahnya dan lebih banyak mendiami Indonesia bagian barat. Secara lebih spesifik, suku bangsa Jawa adalah suku bangsa terbesar dengan populasi mencapai 42% dari seluruh penduduk Indonesia.
